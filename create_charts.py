...
gnuplot.plot_data(
    ...
    'using 4 title "Average item popularity" with lines lc "red" lw 0.2',
    xlabel='"Item rank"',
    ylabel='"Popularity"',
    yrange="[0:]",
...
gnuplot.plot_data(
    ...
    "using 2:xticlabels(1) title columnheader(2) with histograms fs pattern 1",
    "using 3 title columnheader(3) with histograms fs pattern 1",
    'using 4 title "Average item age" with lines lc "red" lw 0.2',
    xlabel='"Item rank"',
    ylabel='"Age (Days)"',
    yrange="[0:]",
...
gnuplot.plot_data(
    ...
    "using 2:xticlabels(1) title columnheader(2) with histograms fs pattern 1",
    "using 3 title columnheader(3) with histograms fs pattern 1",
    'using 4 title "Average item price" with lines lc "red" lw 0.2',
    xlabel='"Item rank"',
    ylabel='"Price"',
    yrange="[0:]",
